...
//
// os.FindProcess plus Signal(0) does not work here — Windows has no signals,
// and FindProcess opens a handle that keeps succeeding for a pid that has
// already exited but whose handle is still open. Asking for the exit code is
// the reliable test.
//
